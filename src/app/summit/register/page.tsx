...
export const metadata: Metadata = {
  title: "Register — Quantum State Summit",
  description: "Early bird registration for the Quantum State Summit.",
  robots: { index: false },
};
    ...
    <div className="relative overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-[60vh] max-w-3xl flex-col items-center justify-center px-4 py-24 text-center sm:px-6">
        ...
        <p className="mt-6 max-w-xl text-lg italic leading-relaxed text-dim">
          Ticketing is being finalized alongside the venue announcement.
          Subscribe and you'll get the early bird window before it's public.
        </p>
